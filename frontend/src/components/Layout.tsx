...
import { LayoutDashboard, Users, Activity, Settings, Server, Languages, Globe, BookOpen, KeyRound, Image as ImageIcon, ShieldAlert, ExternalLink, ChevronLeft, Palette, Sun, Moon, LogOut, Download, Loader2, RefreshCw, Menu, X, CircleDollarSign, Braces, FlaskConical, Shield } from 'lucide-react'
...
const navDefs: NavDef[] = [
  ...
  { to: '/turn-state', labelKey: 'nav.turnState', icon: <Shield className="size-[18px]" /> },
